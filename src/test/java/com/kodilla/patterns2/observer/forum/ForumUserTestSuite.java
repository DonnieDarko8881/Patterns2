...
public class ForumUserTestSuite {
    ...
    public void testUpdate(){
        ...
        ForumUser invoneEscobar = new ForumUser("Ivone Escobar");
        ForumUser jessiePinkman = new ForumUser("Jessy Pinkman");
        javaHelpForum.registerObserver(johnSmith);
        javaToolsForum.registerObserver(invoneEscobar);
        ...
        assertEquals(2,invoneEscobar.getUpdateCount());
